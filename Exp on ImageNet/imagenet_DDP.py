...
parser.add_argument('--momentum_MAN', type=float, default=0.995,)
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    model = eval('networks.' + args.arch + '.' + args.net)(local_module_num = args.local_module_num,momentum = args.momentum_MAN)
